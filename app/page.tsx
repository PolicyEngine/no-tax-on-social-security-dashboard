...
import { Header, MetricCard, logos } from '@policyengine/ui-kit'
...
const NAV_ITEMS = [
  ...
  { label: 'About', href: 'https://policyengine.org/us/about' },
]
      ...
      <main className="max-w-content mx-auto px-6 py-8 flex flex-col gap-8">
        <header className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground max-w-2xl">
            HR 904 would eliminate federal income taxation of Social Security
            benefits. This dashboard shows its budgetary cost, effect on poverty,
            and how household income changes across the income distribution
            (2026).
          </p>
        </header>
        ...
        {isError && (
          <p className="text-error-foreground">
            Could not load the impact data.
          </p>
        )}
        ...
        {impact && (
          <>
            ...
            <footer className="text-xs text-muted-foreground border-t border-border pt-4">
              ...
              the hosted PolicyEngine API (enhanced CPS, {impact.metadata.time_period}).
              Budgetary figures are single-year and static (no behavioral response).
            </footer>
          </>
        )}
      </main>
